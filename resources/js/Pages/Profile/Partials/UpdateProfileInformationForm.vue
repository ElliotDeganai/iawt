...
export default {
    ...
    data() {
        ...
        return {
            ...
            availableCities: user.country ? getCities(user.country) : [],
            customCity: !!(user.city && user.country && !getCities(user.country).includes(user.city)),
    ...
    methods: {
        ...
        onCitySelect(val) {
            if (val === '__other__') { this.customCity = true; this.form.city = ''; }
            else { this.customCity = false; this.form.city = val; }
        },
        onAvatarChange(e) {
