...
<template>
    <Head title="Administration — Nouvel utilisateur" />

    <AdminLayout>
        <template #header>
            <h1 class="text-lg font-semibold text-gray-800">Ajouter un utilisateur</h1>
        </template>
        ...
        <form class="max-w-2xl bg-white rounded-lg shadow p-6 space-y-4" @submit.prevent="submit">
            ...
            <div>
                ...
                <TextInput v-model="form.password" type="password" class="mt-1" required />
